class OverviewGraph
  ...
  def regenerate!
    ...
    if @fitness_samples.length > 0
      ...
      # average_weight_data_set = @graph_helper.fitness_samples_to_seven_day_weight_average_data_set(@fitness_samples, first_date, last_date)
      ...
      # average_bf_percent_data_set = @graph_helper.fitness_samples_to_seven_day_bfp_average_data_set(@fitness_samples, first_date, last_date)
